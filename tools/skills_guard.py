...
Trust levels:
  - builtin:   Ships with Elidia. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.elidia/\.env|\~/\.elidia/\.env',
     "elidia_env_access", "critical", "exfiltration",
     "directly references Elidia secrets file"),
    ...
    (r'\.elidia/config\.yaml|\.elidia/SOUL\.md',
     "elidia_config_mod", "critical", "persistence",
     "references Elidia configuration files directly"),
...
# scan. `.skillignore` is the Elidia-native name; `.clawhubignore` is honored
