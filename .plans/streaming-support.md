# Streaming LLM Response Support for Elidia Agent
...
```
ELIDIA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ELIDIA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `elidia_cli/config.py` | 1 | +streaming config defaults |
