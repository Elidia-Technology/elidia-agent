"""Elidia CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.elidia/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Elidia Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ✦"              # Shown on exit
      response_label: " ✦ Elidia "       # Response box header label
...
.. code-block:: python
    ...
    from elidia_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Elidia Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.elidia/skins/
...
Drop a YAML file in ``~/.elidia/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ELIDIA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (overrides the Elidia icon fallback)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Elidia — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Elidia Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ✦",
            "response_label": " ✦ Elidia ",
            "prompt_symbol": "❯",
