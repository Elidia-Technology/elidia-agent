"""
Skills configuration for Elidia Agent.
`elidia skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.elidia/config.yaml under:
...
from elidia_cli.config import cfg_get, load_config, save_config
from elidia_cli.colors import Colors, color
from elidia_cli.platforms import PLATFORMS as _PLATFORMS
