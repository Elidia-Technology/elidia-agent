...
def _has_elidia_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ELIDIA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ElidiaHome", str(get_elidia_home()),
        ]
    else:
