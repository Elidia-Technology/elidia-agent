...
Usage:
    elidia pairing list              # Show all pending + approved users
    elidia pairing approve <platform> <code>  # Approve a pairing code
    elidia pairing revoke <platform> <user_id> # Revoke user access
    elidia pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle elidia pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: elidia pairing {list|approve|revoke|clear-pending}")
        print("Run 'elidia pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.elidia/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'elidia pairing list' to see pending codes.\n")
