...
Visual styling mirrors the AiUtils design system (the
``@aiutils/ui`` package the React dashboard uses): the same
...
``tests/elidia_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Elidia Agent</title>
<style>
  /* Brand fonts shipped by @aiutils/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Elidia<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Elidia Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Elidia Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
<p>Install <code>plugins/dashboard-auth-elidia</code> (default) or another
