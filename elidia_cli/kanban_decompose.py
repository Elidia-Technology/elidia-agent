...
Invoked by ``elidia kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Elidia Agent board.
...
def _profile_author() -> str:
    """Mirror of ``elidia_cli.kanban._profile_author``."""
    return (
