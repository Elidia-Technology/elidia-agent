...
cd apps/desktop
XCURSOR_SIZE=24 ELIDIA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/elidia-typing
# → /tmp/elidia-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/elidia-typing.before.heapsnapshot
# → /tmp/elidia-typing.after.heapsnapshot
```
