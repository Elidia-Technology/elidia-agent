...
const desktopWindow = window as unknown as { elidiaDesktop?: Window['elidiaDesktop'] }
const initialElidiaDesktop = desktopWindow.elidiaDesktop

function installDesktopBridge(partial: Partial<Window['elidiaDesktop']> = {}) {
  desktopWindow.elidiaDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['elidiaDesktop']
}
...
afterEach(() => {
  ...
  if (initialElidiaDesktop) {
    desktopWindow.elidiaDesktop = initialElidiaDesktop
  } else {
    delete desktopWindow.elidiaDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['elidiaDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['elidiaDesktop']['openExternal'] })
