...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|elidia):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.elidiaDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.elidiaDesktop?.openExternal?.(href)
  }
}
