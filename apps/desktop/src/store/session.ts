...
import type { SessionInfo, UsageStats } from '@/types/elidia'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'elidia.desktop.workspace-cwd'
...
export const $connection = atom<ElidiaConnection | null>(null)
...
export const setConnection = (next: Updater<ElidiaConnection | null>) => updateAtom($connection, next)
