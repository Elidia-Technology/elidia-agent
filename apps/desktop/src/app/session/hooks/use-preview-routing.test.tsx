...
describe('usePreviewRouting', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, 'elidiaDesktop', {
      configurable: true,
      value: {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.elidiaDesktop.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('elidia.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
