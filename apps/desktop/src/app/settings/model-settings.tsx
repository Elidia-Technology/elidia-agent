...
import { getAuxiliaryModels, getGlobalModelInfo, getGlobalModelOptions, setModelAssignment } from '@/elidia'
import type { AuxiliaryModelsResponse, ModelOptionProvider } from '@/elidia'
...
// Mirrors `_AUX_TASK_SLOTS` in elidia_cli/web_server.py. Friendly labels and
