...
const RELEASE_NOTES_URL = 'https://github.com/Elidia-Technology/elidia-agent/releases'
  ...
  return (
    <SettingsContent>
      ...
      <div className="mx-auto mt-4 w-full max-w-2xl">
            ...
            >
              <a
                ...
                onClick={event => {
                  ...
                  void window.elidiaDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
        ...
        <ListRow
          description="Elidia checks for updates automatically in the background and lets you know when one is ready."
