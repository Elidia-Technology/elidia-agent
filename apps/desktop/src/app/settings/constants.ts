...
export const EMPTY_SELECT_VALUE = '__elidia_empty__'
...
export const FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  timezone: 'Used when Elidia needs local time context. Blank uses the system timezone.',
  ...
  file_read_max_chars: 'Maximum characters Elidia can read from one file request.',
  'approvals.mode': 'How Elidia handles commands that need explicit approval.',
  ...
  'agent.max_turns': 'Upper bound for tool-calling turns before Elidia stops a run.'
}
