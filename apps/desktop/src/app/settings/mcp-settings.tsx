...
import { type ElidiaGateway, getElidiaConfigRecord, saveElidiaConfig } from '@/elidia'
...
function getServers(config: ElidiaConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved, query }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveElidiaConfig(nextConfig)
