import type { ElidiaConfigRecord, ToolsetInfo } from '@/types/elidia'
...
export function getNested(obj: ElidiaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ElidiaConfigRecord, path: string, value: unknown): ElidiaConfigRecord {
...
function personalityOptions(config: ElidiaConfigRecord): string[] {
