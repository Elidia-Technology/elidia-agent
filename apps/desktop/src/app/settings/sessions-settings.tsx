...
import { deleteSession, listSessions, setSessionArchived } from '@/elidia'
import { sessionTitle } from '@/lib/chat-runtime'
import { triggerHaptic } from '@/lib/haptics'
import { Archive, ArchiveOff, FolderOpen, Loader2, Trash2 } from '@/lib/icons'
import { notify, notifyError } from '@/store/notifications'
import { setSessions } from '@/store/session'
import type { SessionInfo } from '@/types/elidia'
...
// / Program Files), which buried any files Elidia wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.elidiaDesktop` is
    ...
    const settings = window.elidiaDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || `Defaults to ${fallback || '~/elidia-projects'}.`}
