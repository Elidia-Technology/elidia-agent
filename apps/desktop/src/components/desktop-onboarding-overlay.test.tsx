...
describe('onboarding Picker', () => {
  it('features Elidia Portal and hides other providers behind a disclosure', () => {
    setProviders([provider('anthropic', 'Anthropic Claude'), provider('elidia', 'Elidia Portal')])
  ...
  it('shows every provider directly when Elidia Portal is absent', () => {
