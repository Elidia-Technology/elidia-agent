...
Config: ~/.elidia/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.elidia/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_elidia_home()`` helper (ELIDIA_HOME-aware and
...
RULES_FILE = get_elidia_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_elidia_home() / "feishu_comment_pairing.json"
