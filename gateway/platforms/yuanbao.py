...
try:
    ...
    _ELIDIA_VERSION = "0.0.0"

_APP_VERSION = _ELIDIA_VERSION
_BOT_VERSION = _ELIDIA_VERSION
_YUANBAO_INSTANCE_ID = str(ELIDIA_INSTANCE_ID)  # single source: yuanbao_proto.ELIDIA_INSTANCE_ID
