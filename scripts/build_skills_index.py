#!/usr/bin/env python3
"""Build the Elidia Skills Index — a centralized JSON catalog of all skills.
...
`elidia skills search/install` can use it without hitting the GitHub API.
...
# Ensure ELIDIA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Elidia Skills Index...", flush=True)
