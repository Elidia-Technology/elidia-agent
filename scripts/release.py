...
VERSION_FILE = REPO_ROOT / "elidia_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "annguyenElidia@users.noreply.github.com": "annguyenElidia",
    "32201324+simpolism@users.noreply.github.com": "simpolism",
    "simpolism@gmail.com": "simpolism",
    "jake@aiutils.io": "simpolism",
    ...
    "elidia@marian.local": "Schrotti77",
    ...
    "annguyenElidia@users.noreply.github.com": "annguyenElidia",
    "285874597+annguyenElidia@users.noreply.github.com": "annguyenElidia",
    ...
    "274096618+elidia-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "mind-dragon@elidia.research": "Mind-Dragon",
    ...
    "shannon@aiutils.io": "shannonsands",
    ...
    "elidia@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (ELIDIA_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (ELIDIA_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: elidia-eval community link)
    ...
    "elidiaagent26@gmail.com": "elidiaagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+elidiaagent26@users.noreply.github.com": "elidiaagent26",
    ...
    "clement@aiutils.io": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@elidia": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.elidia@agentmail.to": "oseftg",
    ...
    "ethie@elidia": "ethernet8023",  # PR #29342 (TUI clipboard copy on linux/wayland)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Elidia runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level ELIDIA_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Elidia
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"elidia-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "elidia@aiutils.io"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/Elidia-Technology/elidia-agent",
    ...
    lines.append(f"# Elidia Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Elidia Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Elidia Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Elidia Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Elidia Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Elidia Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Elidia Agent v{new_version} ({calver_date})' "
