...
The main() function in elidia_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `elidia -c model`
...
def _build_parser():
    """Build a minimal replica of the elidia top-level parser."""
