"""Tests for the interactive session browser (`elidia sessions browse`).
...
from elidia_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """elidia sessions browse should be parseable."""
