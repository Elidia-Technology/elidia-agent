...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (ELIDIA_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via ELIDIA_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in ELIDIA_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from elidia_cli.providers import ELIDIA_OVERLAYS
        assert "bedrock" in ELIDIA_OVERLAYS

    def test_bedrock_overlay_transport(self):
        from elidia_cli.providers import ELIDIA_OVERLAYS
        assert ELIDIA_OVERLAYS["bedrock"].transport == "bedrock_converse"

    def test_bedrock_overlay_auth_type(self):
        from elidia_cli.providers import ELIDIA_OVERLAYS
        assert ELIDIA_OVERLAYS["bedrock"].auth_type == "aws_sdk"
