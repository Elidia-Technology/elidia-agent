"""Tests for the specifier module + `elidia kanban specify` CLI surface.
...
from elidia_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `elidia kanban …` argparse surface directly."""
