...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from elidia_cli.models import normalize_provider
    ...
    def test_normalize_provider_providers_py(self):
        from elidia_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
# =============================================================================
# CANONICAL_PROVIDERS (elidia model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / Elidia Portal curated lists
# =============================================================================


class TestTencentInOpenRouterAndElidia:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and Elidia curated lists."""

    def test_in_openrouter_fallback(self):
        from elidia_cli.models import OPENROUTER_MODELS
    ...
    def test_in_elidia_provider_models(self):
        from elidia_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["elidia"]
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from elidia_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from elidia_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in ELIDIA_OVERLAYS
        overlay = ELIDIA_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubDoctor:
    """Verify elidia doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from elidia_cli.providers import ELIDIA_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = ELIDIA_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``elidia model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from elidia_cli import main as main_mod
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from elidia_cli.models import _KNOWN_PROVIDER_NAMES
