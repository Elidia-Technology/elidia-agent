"""Tests for elidia_cli.model_normalize — provider-aware model name normalization.
...
class TestAggregatorProviders:
    ...
    def test_elidia_prepends_vendor(self):
        result = normalize_model_for_provider("gpt-5.4", "elidia")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (Elidia portal, OpenRouter via DeepInfra) routes to V3 —
