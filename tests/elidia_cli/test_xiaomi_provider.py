...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from elidia_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ELIDIA_OVERLAYS
        overlay = ELIDIA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify elidia doctor recognizes Xiaomi env vars."""
