...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_elidia_active_label(self, monkeypatch):
        from elidia_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_elidia=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(elidia_row, config) is False
