...
def isolated_home(monkeypatch):
    """Temp ELIDIA_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="elidia_test_31179_")
    elidia_home = os.path.join(test_home, ".elidia")
    os.makedirs(elidia_home)
...
def _fresh_modules():
    """Drop cached elidia modules so each test reloads against current env."""
