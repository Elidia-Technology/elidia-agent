...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.elidia/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at elidia_state import time, before pytest's ELIDIA_HOME monkeypatch
    fires — the autouse fixture's ELIDIA_HOME override doesn't help here.)
    """
    import elidia_state
