...
def test_import_loads_env_from_elidia_home(tmp_path, monkeypatch):
    home = tmp_path / ".elidia"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-elidia-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-elidia-home"
