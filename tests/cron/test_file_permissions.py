...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("elidia_cli.config.get_config_path", return_value=config_path), \
             patch("elidia_cli.config.ensure_elidia_home"):
    ...
    def test_ensure_elidia_home_sets_0700(self):
        home = Path(self.tmpdir) / ".elidia"
        with patch("elidia_cli.config.get_elidia_home", return_value=home):
