...
The unit tests in tests/elidia_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned elidia-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/elidia")
from elidia_cli.service_manager import S6ServiceManager
