...
5. Recovery is skipped for aggregator providers (OpenRouter, Elidia)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_elidia_provider(self):
        agent = _make_agent(provider="elidia", base_url="https://inference.elidia.aiutils.io/v1")
        error = _make_transport_error("ReadTimeout")
