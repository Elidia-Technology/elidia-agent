...
class TestErrorResponseShapes:
    ...
    def test_firecrawl_config_error_points_paid_users_to_elidia_subscription(self, monkeypatch):
        from plugins.web.firecrawl import provider as firecrawl_provider

        monkeypatch.setattr(
            "tools.web_tools.managed_elidia_tools_enabled",
            lambda: True,
            raising=False,
        )
        ...
        assert "With your Elidia subscription you can also use the Tool Gateway" in message
        assert "select Elidia Subscription as the web provider" in message
    ...
    def test_firecrawl_config_error_uses_entitlement_message_when_not_paid(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "tools.web_tools.elidia_tool_gateway_unavailable_message",
