...
def worker_loop(worker_id: int, elidia_home: str, result_file: str) -> None:
...
def reclaimer_loop(elidia_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="elidia_mixed_stress_")
    print(f"ELIDIA_HOME = {home}")
