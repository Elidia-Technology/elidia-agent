#!/usr/bin/env python3
"""
SWE Runner with Elidia Trajectory Format

A runner that uses Elidia-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Elidia-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Elidia-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Elidia format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Elidia-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Elidia-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Elidia Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Elidia-Agent's built-in execution environments
    and outputs trajectories in Elidia-Agent format.
    """
    ...
    def _convert_to_elidia_format(
        ...
        """
        Convert internal message format to Elidia trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Elidia trajectory format
        trajectory = self._convert_to_elidia_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Elidia trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Elidia Trajectory Format")
    print("=" * 60)
