...
import type { ScrollBoxHandle } from '@elidia/ink'
import { evictInkCaches } from '@elidia/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ELIDIA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
