 ...
 *
 * Symptom: in `elidia --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@elidia/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using elidia --tui and as i type multiline my caret at the end will often ' +
