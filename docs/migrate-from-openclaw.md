...
> [!TIP]
> If your OpenClaw setup was multi-provider, `elidia setup --portal` collapses it to one OAuth — 300+ models plus the Tool Gateway in a single login. See [Elidia Portal](elidia-portal.md).
...
| Plugins | `archive/plugins-config.json` | See [plugins guide](https://aiutils.io/elidia/user-guide/features/hooks) |
