# Elidia Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.elidia/plugins/elidia-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.elidia/plugins/elidia-achievements/scan_checkpoint.json`.
