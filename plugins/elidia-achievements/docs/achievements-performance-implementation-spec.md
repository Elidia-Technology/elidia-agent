# Elidia Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.elidia/plugins/elidia-achievements/state.json` (existing unlock state)
  - `~/.elidia/plugins/elidia-achievements/scan_snapshot.json` (new)
  - `~/.elidia/plugins/elidia-achievements/scan_checkpoint.json` (new)
