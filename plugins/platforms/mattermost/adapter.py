...
required — uses aiohttp which is already an Elidia dependency.
...
def interactive_setup() -> None:
    ...
    ``elidia_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Elidia delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # elidia_cli/setup.py::_setup_mattermost function.
