...
``_check_spotify_available()`` — when the user has not run ``elidia auth
spotify``, the tools remain registered (so they appear in ``elidia
...
The Spotify auth flow (``elidia auth spotify``), CLI plumbing, and docs
