# nix/web.nix — Elidia Web Dashboard (Vite/React) frontend build
{ pkgs, elidiaNpmLib, ... }:
let
  npm = elidiaNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "elidia-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../elidia_cli/web_dist for the
