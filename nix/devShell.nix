...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      elidiaNpmLib = self'.packages.default.passthru.elidiaNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. elidia-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Elidia Agent dev shell"
          ${combinedNonNpm}
          ${elidiaNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}
          echo "Ready. Run 'elidia' to start."
        '';
      };
    };
}
