...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Elidia Agent — dev setup, code style, PR process"
---
...
- Building a custom/local tool without modifying Elidia core? Start with [Build an Elidia Plugin](../guides/build-a-elidia-plugin.md)
- Building a new built-in core tool for Elidia itself? Start with [Adding Tools](./adding-tools.md)
