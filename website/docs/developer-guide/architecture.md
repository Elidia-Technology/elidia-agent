...
sidebar_position: 1
title: "Architecture"
description: "Elidia Agent internals — major subsystems, execution paths, data flow, and where to read next"
---
...
→ [Plugin Guide](/guides/build-a-elidia-plugin), [Memory Provider Plugin](./memory-provider-plugin.md)
