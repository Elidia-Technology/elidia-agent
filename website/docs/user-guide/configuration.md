...
sidebar_position: 2
title: "Configuration"
description: "Configure Elidia Agent — config.yaml, providers, models, API keys, and more"
---
...
Run `elidia setup --portal` — one OAuth gets you a model provider and all four Tool Gateway tools without hand-editing YAML. Portal subscribers also get 10% off token-billed providers. See [Elidia Portal](/integrations/elidia-portal).
:::
...
<div style={{position: 'relative', width: '100%', aspectRatio: '16 / 9', marginBottom: '1.5rem'}}>
  <iframe
    ...
    title="Elidia Agent — Auxiliary Models Tutorial"
...
```
Run `elidia model` and select **MiniMax (OAuth)** to log in and set this automatically. For the China region, the base URL will be `https://api.minimaxi.com/anthropic`. See the [MiniMax OAuth guide](../guides/minimax-oauth.md) for the full walkthrough.
