...
:::tip
Cron jobs use whatever provider `elidia model` selected. `elidia setup --portal` is the lowest-friction option for unattended runs since OAuth refresh is automatic. See [Elidia Portal](/integrations/elidia-portal).
:::
