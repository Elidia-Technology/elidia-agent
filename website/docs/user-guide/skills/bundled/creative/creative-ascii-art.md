...
```bash
python3 -m pyfiglet "ELIDIA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ELIDIA&font=Slant" | boxes -d stone
```
