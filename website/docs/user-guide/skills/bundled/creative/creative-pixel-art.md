...
```python
import sys
sys.path.insert(0, "/home/teknium/.elidia/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.elidia/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Elidia installs package this)
