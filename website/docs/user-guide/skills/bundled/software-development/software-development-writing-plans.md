...
| Version | `1.1.0` |
| Author | Elidia Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Elidia:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Elidia tools to understand the project:
