...
Control the user's Spotify account via the Elidia Spotify toolset (7 tools). Setup guide: https://aiutils.io/elidia/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `elidia auth spotify` again.
