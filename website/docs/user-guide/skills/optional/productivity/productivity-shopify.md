...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Elidia","productType":"Apparel","tags":["test"]}}'
```
