...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/research/qmd` |
...
Elidia Agent via the native MCP client. This is the preferred
...
Then configure Elidia Agent to connect via HTTP:
