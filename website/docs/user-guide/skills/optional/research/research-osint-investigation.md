...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Elidia Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ELIDIA_OSINT_CACHE/icij/ (default: ~/.cache/elidia-osint/icij/).
...
# Set ELIDIA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
