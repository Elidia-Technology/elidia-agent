...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Elidia Agent |
| License | MIT |
...
The script reads `~/.elidia/.env` for two optional defaults:
...
Helper script: `~/.elidia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.elidia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.elidia/.env`.
...
```bash
python3 ~/.elidia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.elidia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
