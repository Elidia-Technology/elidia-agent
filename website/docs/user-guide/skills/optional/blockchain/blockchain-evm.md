...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Elidia Agent |
| License | MIT |
...
Helper script path: `~/.elidia/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.elidia/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.elidia/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.elidia/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
