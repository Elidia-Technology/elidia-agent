...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Elidia Agent |
| License | MIT |
...
```
SCRIPT=~/.elidia/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.elidia/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
