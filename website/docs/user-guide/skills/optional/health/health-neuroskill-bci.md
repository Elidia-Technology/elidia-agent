...
| | |
|---|---|
| Source | Optional — install with `elidia skills install official/health/neuroskill-bci` |
...
Connect Elidia to a running [NeuroSkill](https://neuroskill.com/) instance to read
