...
- User wants **Elidia itself to drive a browser** → use Elidia' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
