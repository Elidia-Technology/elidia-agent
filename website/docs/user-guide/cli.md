...
sidebar_position: 1
title: "CLI Interface"
description: "Master the Elidia Agent terminal interface — commands, keybindings, personalities, and more"
---
...
One command — `elidia setup --portal` — and you're ready to `elidia chat`. See [Elidia Portal](/integrations/elidia-portal).
:::

:::tip
Elidia also ships a modern TUI with modal overlays, mouse selection, and non-blocking input. Launch it with `elidia --tui` — see the [TUI](tui.md) guide.
:::
