...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-elidia-agent',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/software-development/software-development-elidia-agent-skill-authoring',
                    'user-guide/skills/bundled/software-development/software-development-elidia-s6-container-supervision',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-elidia-with-elidia-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-elidia',
        'guides/use-soul-with-elidia',
        'guides/use-voice-mode-with-elidia',
        'guides/build-a-elidia-plugin',
