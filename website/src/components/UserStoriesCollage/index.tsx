  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Elidia Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Elidia &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Elidia?{' '}
        <a
          href="https://github.com/Elidia-Technology/elidia-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/AiUtils" target="_blank" rel="noopener noreferrer">
          AiUtils Discord
        </a>{' '}
