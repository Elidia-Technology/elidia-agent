...
#
# See: https://github.com/Elidia-Technology/elidia-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Elidia) run before
    ...
    if status_code == 404:
        # Elidia API currently surfaces HA/NAS credit depletion as a paid model
