...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - elidia_home (str): The active ELIDIA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.elidia``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "elidia").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'elidia memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], elidia_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'elidia memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``elidia_home`` is the active ELIDIA_HOME directory path.
