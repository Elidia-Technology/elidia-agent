...
projection into Elidia' display, approval bridging, transcript projection into
...
"codex_app_server"`. Elidia' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("ELIDIA_KANBAN_TASK"):
            kanban_db = spawn_env.get("ELIDIA_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "ELIDIA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("ELIDIA_HOME", os.path.expanduser("~/.elidia")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "elidia",
        client_title: str = "Elidia Agent",
