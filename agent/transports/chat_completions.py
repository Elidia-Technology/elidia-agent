...
providers (OpenRouter, Elidia, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Elidia/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Elidia'
    ...
    # is stricter (low/high). Clamp Elidia' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Elidia-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Elidia-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Elidia max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Elidia, OpenRouter,
        ...
        is_elidia = params.get("is_elidia", False)
