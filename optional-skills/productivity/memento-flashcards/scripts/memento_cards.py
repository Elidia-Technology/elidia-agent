...
Data file: $ELIDIA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ELIDIA_HOME = Path(os.environ.get("ELIDIA_HOME", Path.home() / ".elidia"))
DATA_DIR = _ELIDIA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
