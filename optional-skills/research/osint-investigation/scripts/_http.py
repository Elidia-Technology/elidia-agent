...
DEFAULT_UA = (
    "elidia-osint-investigation/0.2 "
    "(+https://github.com/Elidia-Technology/elidia-agent; "
    "set ELIDIA_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ELIDIA_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
