...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateElidia: "Elidia frissítése",
    updatingElidia: "Elidia frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Elidia-bővítmények felfedezése, telepítése, engedélyezése és frissítése (az `elidia plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.elidia/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.elidia/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.elidia/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Elidia-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Elidia munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet az Elidiat",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint az Elidia kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "Az Elidia egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
