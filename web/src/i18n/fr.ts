...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateElidia: "Mettre à jour Elidia",
    updatingElidia: "Mise à jour de Elidia…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Elidia (parité avec `elidia plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.elidia/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.elidia/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.elidia/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Elidia Achievements",
      subtitle:
        "Badges Elidia à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Elidia en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Elidia davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Elidia détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Elidia analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Elidia Agent ✦",
    },
  },
  kanban: {
