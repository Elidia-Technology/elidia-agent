...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateElidia: "Werk Elidia op",
    updatingElidia: "Besig om Elidia op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Elidia-inproppe op (`elidia plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.elidia/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.elidia/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.elidia/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Elidia-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Elidia-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Elidia meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Elidia 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Elidia skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
