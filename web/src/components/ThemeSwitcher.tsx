...
import { BottomSheet } from "@aiutils/ui/ui/components/bottom-sheet";
 ...
 * themes from `~/.elidia/dashboard-themes/*.yaml` use their API-provided
...
function ThemeSwatch({ theme }: { theme: DashboardTheme }) {
  // Inverted themes (Elidia Blue / future lens themes) author their palette
