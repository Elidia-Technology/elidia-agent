import { useGpuTier } from "@aiutils/ui/hooks/use-gpu-tier";

import fillerBgUrl from "@aiutils/ui/assets/filler-bg0.webp";

/**
 * Replicates the visual layer stack of `<Overlays dark />` from
 * `@aiutils/ui` without pulling in its leva / gsap / three peer deps.
 *
 * See `design-language/src/ui/components/overlays/index.tsx` for the source of
 * truth. Defaults match LENS_0 (the Elidia teal dark preset); the deep canvas
 ...
 *         Both LENS_0-style dark themes and the LENS_5I-style Elidia Blue
