 ...
 *  `index.css` (Elidia-teal `#ffe6cb` for input, `#34d399` for output).
 *
 *  Inverted-lens themes (e.g. Elidia Blue) must pre-invert these hex
 *  values so they read as their intended visual color after the FG
 *  difference layer flips them (`out = 255 − channel`). E.g. to make
 *  output paint as Elidia-blue `#0053FD` on screen, set
...
export interface ThemeListEntry {
   ...
   *  `~/.elidia/dashboard-themes/*.yaml`; undefined for built-ins (the
