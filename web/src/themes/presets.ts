 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `elidia_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Elidia Teal",
  description: "Classic dark teal — the canonical Elidia look",
  palette: {
...
/**
 * Elidia Blue — the inverted "light mode" Elidia look, ported from the
 * LENS_5I overlay preset in `@aiutils/ui`.
 *
 ...
 * the orange midground reads as #0053FD Elidia-blue on screen, against a
 * cream `#E8F2FD` canvas.
 *
 * Note on bg blend mode: the DS Lens uses `multiply` for LENS_5I because
 * nousnet-web's <body> is white; elidia-agent's App root is `bg-black`,
 ...
 */
export const elidiaBlueTheme: DashboardTheme = {
  name: "elidia-blue",
  label: "Elidia Blue",
  description: "Light mode — vivid Elidia-blue accents on cream canvas",
  palette: {
  ...
  // bright Elidia-blue canvas — the coral is the "red" users see for
  // Output values without these overrides. Source → on-screen:
  //   Input:  #ffe6cb → #001934 (dark navy)        ← unchanged
  //   Output: #ffac02 → #0053fd (vivid Elidia-blue)  ← brand accent
  ...
  // Elidia-blue so the "primary" series in token-flow charts reads as
  ...
  //   white → vivid Elidia-blue → cream/light-blue
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Elidia Teal (Large)",
  description: "Elidia Teal with bigger fonts and roomier spacing",
