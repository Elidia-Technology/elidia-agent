 ...
 *
 * Plugins call window.__ELIDIA_PLUGINS__.register(name, Component)
...
import { Card, CardHeader, CardTitle, CardContent } from "@aiutils/ui/ui/components/card";
import { Input } from "@aiutils/ui/ui/components/input";
import { Label } from "@aiutils/ui/ui/components/label";
import { Separator } from "@aiutils/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@aiutils/ui/ui/components/tabs";
...
export function exposePluginSDK() {
  window.__ELIDIA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ELIDIA_PLUGIN_SDK__ = {
    ...
    // UI components — Elidia DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
