 ...
 * `window.__ELIDIA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Elidia brand in the top bar
 ...
 *  `window.__ELIDIA_PLUGINS__.registerSlot(...)`.
 *
