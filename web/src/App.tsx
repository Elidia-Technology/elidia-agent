...
import { SelectionSwitcher } from "@aiutils/ui/ui/components/selection-switcher";
...
import { useBelowBreakpoint } from "@aiutils/ui/hooks/use-below-breakpoint";
...
const SIDEBAR_COLLAPSED_KEY = "elidia-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="elidia-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="elidia-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateElidia,
      runningLabel: t.status.updatingElidia,
      spin: false,
    },
  ];
