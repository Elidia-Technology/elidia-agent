...
description: Use when an Elidia Kanban worker wants to run Codex CLI as an isolated implementation lane while Elidia keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Elidia Agent
license: MIT
metadata:
  elidia:
    ...
    related_skills: [kanban-worker, codex, elidia-agent]
---
