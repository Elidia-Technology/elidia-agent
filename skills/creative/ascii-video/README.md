...
Built for [Elidia Agent](https://github.com/Elidia-Technology/elidia-agent). Usable in any coding agent. Canonical source lives here; synced to [`AiUtils/elidia-agent/skills/creative/ascii-video`](https://github.com/Elidia-Technology/elidia-agent/tree/main/skills/creative/ascii-video) via PR.
